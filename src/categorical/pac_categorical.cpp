...
// ============================================================================
// TODO(priv-rename): PacCategoricalBindData / PacCategoricalLocalState /
// PacCategoricalBind / PacCategoricalInitLocal / GetPacFilterParams /
// ComparePacFloat / PacFilterCmpOp / GetPacFilterCmpName / GetPacSelectCmpName
// are now shared by both the PAC (majority-vote) and SASS (median-region) paths.
// A single sweep should rename Pac→Priv across these ~70 call sites; intentionally
// deferred from this PR to keep the diff scoped.
