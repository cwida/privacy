...
\paragraph{Roadmap.} \S1 motivates the problem and fixes the baseline. \S2 states the four ideas.
\S3 measures utility and establishes the scope condition. \S4 covers automatic $\Cu$ selection,
\S5 the one idea that does not work. \S6 is privacy validation, including two bugs we found in our
own mechanism. \S7 is methodology, \S8 prior art, \S9 recommendations.
