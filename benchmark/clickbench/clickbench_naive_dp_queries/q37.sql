...
-- Q37: URL, COUNT(*) PageViews [july filters, DontCountHits=0,IsRefresh=0,URL<>''] GROUP BY URL ORDER BY PageViews DESC LIMIT 10
WITH samples AS (
...
per_sample AS (
    ...
    WHERE h.CounterID = 62 AND h.EventDate >= '2013-07-01' AND h.EventDate <= '2013-07-31' AND h.DontCountHits = 0 AND h.IsRefresh = 0 AND h.URL <> ''
