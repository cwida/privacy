...
-- Q40: TraficSourceID, SearchEngineID, AdvEngineID, CASE..Src, URL Dst, COUNT(*) PageViews GROUP BY ... ORDER BY PageViews DESC LIMIT 10 OFFSET 1000
WITH samples AS (
...
per_sample AS (
    SELECT s.sample_id, h.TraficSourceID, h.SearchEngineID, h.AdvEngineID,
           ...
           h.URL AS Dst, COUNT(*) AS PageViews
